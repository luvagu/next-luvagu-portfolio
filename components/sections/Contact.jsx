...
function Contact() {
	...
	return (
		<section
			id='contact'
			ref={revealObject}
			className='mt-0 mx-auto mb-12 md:mb-24 py-14 sm:py-20 md:py-24 px-0 max-w-600 text-center'
		>
			<h2 className='block mb-4 mt-2.5 mx-0 w-full text-yellow-400 text-lg font-normal'>
				Have Questions?
			</h2>

			<h2 className='text-4xl md:text-5xl mb-6 font-bold text-gray-300 leading-tight'>
				Contact Me
			</h2>
			...
			<p>
				...
				At present I am not looking for new opportunities. However, if
				you&apos;d like to get in touch with me I&apos;ll do my best to respond
				to your queries!
			</p>
