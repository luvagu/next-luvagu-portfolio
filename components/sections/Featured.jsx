                ...
                {featuredProjects && featuredProjects.map(({ external, title, tech, github, cover, html }, idx) => (
                    ...
                    >
                        ...
                        <div className="project-content relative">
                            <div>
                                <p className="project-label my-2.5 mx-0 text-yellow-400 font-mono text-sm font-normal">Pinned Project</p>
                                ...
                                <div className="project-description relative py-5 px-0 md:p-6 rounded bg-transparent md:bg-gray-800 text-gray-300 text-base shadow-none md:shadow-xl hover:shadow-2xl transition-all duration-300" dangerouslySetInnerHTML={{ __html: html }} />
                                ...
                                <div className="project-links flex items-center relative mt-2.5 -ml-2.5 text-gray-300">
                                    ...
                                    {external && (
                                        <a 
                                            ...
                                            className="relative flex justify-center items-center p-2.5 hover:text-yellow-400 focus:text-yellow-400 focus:ring-1 focus:ring-yellow-400 focus:outline-none transition-all duration-300"
                                        >
                                            <RenderIcon name='External' height='h-5' width='w-5 -mt-1' />
                                        </a>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="project-cover relative opacity-25 md:opacity-100 shadow-lg hover:shadow-xl w-full max-w-full h-full bg-yellow-400 rounded align-middle overflow-hidden hover:bg-transparent transition-all duration-200">
                            <div className="cover-filter relative rounded overflow-hidden mix-blend-multiply filter grayscale contrast-100 brightness-50 md:brightness-75 h-full">
                                <Image alt={title} src={cover} layout="fill" objectFit="cover" objectPosition="top" />
                            </div>
                        </div>
                    </li>
                ))}
